...
- 每次开始前，先读取 `AGENTS.md`、`docs/tasks.md`（索引）与对应的 `docs/tasks/<里程碑>.md`，以及本次相关规格。
...
- 新决策新建 `docs/decisions/ADR-<编号>-<slug>.md`，新门禁改 `scripts/verify/<领域>.sh`；不要把内容追加进共享单文件（AGENTS.md §3「写争用规则」）。
