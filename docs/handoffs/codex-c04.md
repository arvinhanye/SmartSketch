...
- 状态与基线：本分支功能完成并通过本地验证；`codex/c04-courses-api` 基于 C03 提交 `44f77cf`，其父提交为当前本地 main `a7a0be0`。C03 PR #216 仍以 main 为目标且未合并；C04 不能据此声称合并后集成通过。
