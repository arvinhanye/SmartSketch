...
- 基线：`codex/a10-batch1@b801553`；本次交付为未提交改动
- ready_for_review：是；请以 `git diff` 和未跟踪的 `tests/contracts/test_b08.py` 为审查范围
...
- 首个后续动作：审查本分支差异，再在 A10 批 1 的集成路径上安排 B09/B10/B11 对新增错误码的引用。
