"""E03: OpenAI-compatible Chat Completions adapter over an injectable HTTP transport.
...
and no key, prompt text or model output ends up in reprs, errors or logs.
